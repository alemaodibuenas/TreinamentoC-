...
namespace ConsoleApp.FakeDB
{
    public static class EstoqueFakeDB
    {
        ...
        {
            SubCategoriaPoco s = new SubCategoriaPoco();
            s.SubCategoriaID = id;
            s.CategoriaID = catid;
            s.Descricao = descricao;
            s.DataInsert = dataInsert;
            subCategorias.Add(s);
        }

        private static void adicionarProduto(int id, int subcatid, int catid, String descricao, DateTime dataInsert)
        {
            ProdutoPoco p = new ProdutoPoco();
            p.ProdutoId = id;
            p.SubCategoriaID = subcatid;
            p.CategoriaID = catid;
            p.Descricao = descricao;
            p.DataInsert = dataInsert;
            produtos.Add(p);
        }
        ...
        public static void inicializarSubCategoria()
        {
            DateTime dataInsert = DateTime.Now;
